...
def test_users(client):
    m = User.new(username="molasse", password="epave")
    assert m.username == "molasse"


def test_bid_wager_update(client):
    g = Game.new()
    u = User.new(password="asdkdlj", username="Jean Test")
...
def test_perfect_bid_removal(client):
    g = Game.new()
    u = User.new(password="asdkdlj", username="Jean Zero")
    g.go_to_idle()
    g.go_to_bidable()
...
def test_negative_bet_cheating(client):
    g = Game.new()
    u = User.new(password="asdkdlj", username="Jean Cheat")
    g.go_to_idle()
    g.go_to_bidable()
